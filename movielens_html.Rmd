...
```{r ,dpi=96,out.width='80%', echo=TRUE,null_prefix =TRUE,eval=FALSE}
...
ggplot(data=edx_movies_metrics, aes(x= reorder(genres, -Ratings_perGenre_Sum),
  ...
  geom_col()
```
![](images/sumofratingspergenre.PNG)
...
```{r , out.width='90%', echo=TRUE,null_prefix =TRUE,cache=TRUE}
...
```{r ,out.width='70%', echo=TRUE,null_prefix =TRUE,eval=FALSE}
...
```{r eval=FALSE}
h2orf1 <- h2o.randomForest( x = c("movieId","userId","n.movies_byUser","n.users_bymovie","Drama",  
